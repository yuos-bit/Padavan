                    ...
                    <div class="round_bottom">
                        ...
                        <div id="wnd_vpns_cfg">
                            ...
                            <table class="table" id="tbl_vpn_config" style="display:none">
                                <tr>
                                    <th colspan="2" style="background-color: #d2c0c021;"><#VPNS_Base#></th>
                                </tr>
                                <tr>
...
                                            <option value="14" <% nvram_match_x("", "vpns_ov_ciph", "14","selected"); %>>[AES-256-GCM] AES-GCM, 256 bit</option>
                                ...
                                <tr>
                                    <th colspan="2" style="background-color: #d2c0c021;"><#VPNS_CTun#></th>
                                </tr>
                            ...
                            <table class="table" id="tbl_vpn_pool" style="display:none">
                                <tr>
                                    <th colspan="2" style="background-color: #d2c0c021;"><#VPNS_PInfo#></th>
                                </tr>
                                <tr>
