                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#VSAuto#></th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#VSManual#></th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table table-list" id="VSList_Block">
                                        <tr>
                                            <th colspan="7" style="background-color: #d2c0c021;"><#IPConnection_VSList_title#></th>
                                        </tr>
                                        <tr>
