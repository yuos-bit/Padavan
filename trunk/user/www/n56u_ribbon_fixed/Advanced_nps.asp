...
$j(document).ready(function() {
    ...
    init_itoggle('npc_enable',change_nps_enable);
    init_itoggle('app_58');
    init_itoggle('app_59');
...
function change_nps_enable(mflag){
    var m = document.form.npc_enable.value;
                        ...
                        <div class="box well grad_colour_dark_blue">
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <div>教程地址: <a href="https://github.com/ehang-io/nps/blob/master/README_zh.md" target="blank">中文文档</a> <a href="https://ehang-io.github.io/nps/" target="blank1">nps图文教程</a></div>
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr id="nps_enable_tr" >
                                            ...
                                            <td>
                                                ...
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" name="npc_enable" id="npc_enable_1" class="input" value="1" onClick="change_nps_enable(1);" <% nvram_match_x("", "npc_enable", "1", "checked"); %> /><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="npc_enable" id="npc_enable_0" class="input" value="0" onClick="change_nps_enable(1);" <% nvram_match_x("", "npc_enable", "0", "checked"); %> /><#checkbox_No#>
                                                </div>
                                            </td>
                                            <td colspan="2">
                                        ...
                                        <tr>
                                            <th colspan="4" style="background-color: rgba(255,255,255,0.2);" >配置 nps 客户端</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th colspan="4" style="background-color: rgba(255,255,255,0.2);" >配置 nps 服务端</th>
                                        </tr>
                                        <tr>
