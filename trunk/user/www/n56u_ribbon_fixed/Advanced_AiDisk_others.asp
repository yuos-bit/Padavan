                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table id="tbl_smbd" width="100%" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#StorageSMBD#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%">
                                                <#enableCIFS#>
                                    ...
                                    <table id="tbl_ftpd" width="100%" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#StorageFTPD#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%">
                                                <#enableFTP#>
                                    ...
                                    <table width="100%" id="tbl_nfsd" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#StorageNFSD#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%">
                                                <#StorageEnableNFSD#>
                                    ...
                                    <table width="100%" id="tbl_minidlna" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="3" style="background-color: #d2c0c021;"><#UPnPMediaServer#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%">
                                                <#StorageEnableDLNA#>
                                    ...
                                    <table width="100%" id="tbl_itunes" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="3" style="background-color: #d2c0c021;"><#StorageFFly#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%">
                                                <#StorageEnableFFly#>
                                    ...
                                    <table width="100%" id="tbl_trmd" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="3" style="background-color: #d2c0c021;"><#StorageTorrent#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%">
                                    ...
                                    <table width="100%" id="tbl_aria" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        <tr>
                                            <th colspan="3" style="background-color: #d2c0c021;"><#StorageAria#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%">
