                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_wps_actions">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#TweaksWPSAction#></th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_fn1_actions" style="display:none;">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#TweaksFN1Action#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%"><#TweaksEventShort#></th>
                                            <td>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_fn2_actions" style="display:none;">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#TweaksFN2Action#></th>
                                        </tr>
                                        <tr>
                                            <th width="50%"><#TweaksEventShort#></th>
                                            <td>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="2" style="background-color: #d2c0c021;"><#TweaksLEDEvents#></th>
                                        </tr>
                                        <tr>
