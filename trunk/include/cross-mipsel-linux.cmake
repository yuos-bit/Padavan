...
# 自动兼容旧的 CONFIG_CROSS_COMPILER_ROOT 和新的 CONFIG_TOOLCHAIN_DIR
if(DEFINED ENV{CONFIG_TOOLCHAIN_DIR})
    set(CROSS_PATH $ENV{CONFIG_TOOLCHAIN_DIR})
elseif(DEFINED ENV{CONFIG_CROSS_COMPILER_ROOT})
    set(CROSS_PATH $ENV{CONFIG_CROSS_COMPILER_ROOT})
else()
    message(FATAL_ERROR "You must set CONFIG_TOOLCHAIN_DIR or CONFIG_CROSS_COMPILER_ROOT")
endif()
